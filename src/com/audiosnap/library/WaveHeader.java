...
public class WaveHeader {
    ...
    public int read(InputStream in) throws IOException {
        ...
        System.out.println("Channels: " + mNumChannels);
        mSampleRate = readInt(in);
        System.out.println("Sample rate: " + mSampleRate);
        int byteRate = readInt(in);
        System.out.println("Byte rate: " + byteRate);
        short blockAlign = readShort(in);
        mBitsPerSample = readShort(in);
        System.out.println("Bits/sample: " + mBitsPerSample);
        System.out.println("Block align: " + blockAlign);
        
        if (byteRate/8 != mNumChannels * mSampleRate * mBitsPerSample / 8) {
...
//        }
        ...
        System.out.println("Data size: " + mNumBytes);
