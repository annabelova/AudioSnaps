...
public class AutoResizeTextButton extends Button {
    ...
    public interface OnTextResizeListener {
        public void onTextResize(Button button, float oldSize, float newSize);
    }
 ...
 // Default constructor override
    ...
    public void resizeText(int width, int height) {
        ...
        if(mAddEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
            ...
            StaticLayout layout = new StaticLayout(text, textPaint, width, Alignment.ALIGN_NORMAL, mSpacingMult, mSpacingAdd, true);
