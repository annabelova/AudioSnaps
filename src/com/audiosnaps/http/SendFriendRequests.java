...
public class SendFriendRequests extends HttpConnections {

	private final static String TAG = "SendFriendRequests";
	private Context context;
	private String userId, friendsId, koeToken;
	private Handler handler;
	private boolean success = false;

	public SendFriendRequests(Context context, Handler handler, String userId, String friendsId, String koeToken) {
		super(context);
	...
	private String doRequest() {
		String result = null;
		try {
			result = sendJson(userSendFriendRequestJsonObject(userId, friendsId), null, koeToken);
