...
public class GetUserSimpleProfileWithSettings extends HttpConnections {

	private final static String TAG = "GetUserSimpleProfileWithSettings";
	private Handler handler;
	private String userId, targetId, koeToken;
	private boolean success = false;
//	private ProgressDialog progressDialog;
//	private Dialogos dialogos;

	public GetUserSimpleProfileWithSettings(Context context, Handler handler, String userId, String targetId, String koeToken) {
		super(context);
...
//		dialogos = new Dialogos(context);
	...
	private String doRequest() {
		String result = null;
		try {
			result = sendJson(userSimpleProfileWithSettingsJsonObject(userId, targetId), null, koeToken);
