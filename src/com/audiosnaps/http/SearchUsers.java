...
public class SearchUsers extends HttpConnections {

	private final static String TAG = "SearchUsers";
...
//	private Dialogos dialogos;
	...
	public SearchUsers(Context context, Handler handler, String userId, String koeToken, String texto, boolean extended) {
		super(context);
		this.userId = userId;
		this.texto = texto;
...
//		dialogos = new Dialogos(context);
	...
	private String doRequest() {
		...
		try {
			result = sendJson(userSearchUsersJsonObject(userId, texto, extended), null, koeToken);
