...
public class GetCompleteFriendsList extends HttpConnections {

	private final static String TAG = "GetCompleteFriendsList";
	...
	private boolean success = false, showLoading = false;

	public GetCompleteFriendsList(Context context, Handler handler, String userId, String targetUserId, boolean includeSocial, boolean includeSuggested, boolean includePending, String koeToken, boolean showLoading) {
		super(context);
	...
	private String doRequest() {
		...
		try {
			...
			if (resultJson.getBoolean(HttpConnections.SUCCES)) {
				JSONArray frinedsJsonArray = resultJson.getJSONArray(FRIENDS_DATA);
	...
	protected String doInBackground(Object... params) {
		//Thread.currentThread().setPriority(android.os.Process.THREAD_PRIORITY_URGENT_DISPLAY);
