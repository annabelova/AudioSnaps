...
public class GetNewNotifications extends HttpConnections {

	private final static String TAG = "GetNewNotifications";
	private Handler handler;
	private String userId, koeToken, forceNum, timeStamp;
	private boolean success = false;
//	private ProgressDialog progressDialog;
//	private Dialogos dialogos;

	public GetNewNotifications(Context context, Handler handler, String userId, String forceNum, String timeStamp, String koeToken) {
		super(context);
...
//		dialogos = new Dialogos(context);
	...
	private String doRequest() {
		String result = null;
		try {
			result = sendJson(userGetNewNotificationsJsonObject(userId, forceNum, timeStamp), null, koeToken);
			...
			if (resultJson.getBoolean(HttpConnections.SUCCES)) {
				jsonArray = resultJson.getJSONArray(HttpConnections.NOTIFICATIONS);
